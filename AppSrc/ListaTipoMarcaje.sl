...
Object ListaTipoMarcaje is a dbModalPanel
    Object oTipoMarcaje_DD is a cTipoMarcajeDataDictionary
    End_Object

    Set Main_DD to oTipoMarcaje_DD
    Set Server to oTipoMarcaje_DD

    Set Size to 133 292
    Set Location     to 4 5
    Set Border_Style to Border_Thick
    Set Label to "Tipo Marcaje"
    ...
    Object oSelList is a dbList
        ...
        Set Header_Label 1 to "TipoMarcaje"
    End_Object
